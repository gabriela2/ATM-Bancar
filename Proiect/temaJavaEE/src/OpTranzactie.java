 ...
 */
public class OpTranzactie extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int codStatus = FctMetodeStatice.initiazaTranzactie(idUtilizator1, idDepozit1, 
				idUtilizator2, idDepozit2, suma);
		if (codStatus!=1){
			System.out.println(codStatus);
			FctMetodeStatice.efectueazaTranzactie(codStatus,idUtilizator1, idDepozit1, 
				idUtilizator2, idDepozit2, suma);

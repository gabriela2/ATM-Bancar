...
/**
 * Servlet implementation class SrvCereFonduri
 */
public class SrvCereFonduri extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SrvCereFonduri() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (utilizatorCautat!=-1 && du1!=null && du2!=null && nume!=null) {
			...
			out.write(""
				...
				+"	<div class='container'>"
				+"	<h1>Tranzactie</h1>"
				+"	<form id='inregistrare' method='post' action='opcerefonduri'>"
				+"		<div>Cere fonduri de la: "+nume[0]+" "+nume[1]+"</div>"
				+"		<br>"
				+"		<label>Selectati depozitul dvs:</label>"
				+ liniiseldepozit1
				+"		<label>Selectati depozitul de la care doriti fonduri:</label>"
				+ liniiseldepozit2
